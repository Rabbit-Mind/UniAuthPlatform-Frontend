...
import Antd, { notification, Popconfirm } from 'ant-design-vue';
...
export function setupFastCrud(app: App) {
  app.use(Antd);
  app.use(ui);
  app.use(FastCrud, {
    // i18n,
            ...
            remove: {
              ...
              render(scope: any) {
                ...
                return (
                  ...
                  >
                    <fs-button class="ant-btn-sm" danger>
                      删除
                    </fs-button>
                  </Popconfirm>
                );
  ...
  app.use(FsExtendsUploader, {
    ...
    form: {
      ...
      uploadRequest: async ({ action, file, onProgress }: any) => {
        ...
        return await requestClient.request(action, {
          method: 'post',
          headers: {
